/**
 * 初始化
 * npm install gulp-util gulp-livereload gulp-imagemin imagemin-pngquant gulp-ruby-sass gulp-sourcemaps gulp-changed gulp-webserver gulp-minify-css gulp-uglify gulp-rename gulp-concat gulp-clean tiny-lr --save-dev
 */
// 引入gulp
...
-------------------------------------------------------------- */
	...
	gulp.task('sass', function () {
     return sass(srcPath.css+'/*.scss', { style: 'compact' }) // 指明源文件路径、并进行文件匹配（style: 'compressed' 表示输出格式）
          .on('error', function (err) {
               console.error('Error!', err.message); // 显示错误信息
          })
	...
	gulp.task('watch',function(){
		...
		// 监听 scss
		gulp.watch( srcPath.css+'/*.scss' , ['sass','cssmin']);
		// 监听 images
